...
int main() {
    ...
    SalariedEmployee salariedEmployee{
        "John", "Smith", "111-11-1111", Date(1, 11, 1990), 800};
    CommissionEmployee commissionEmployee{
        "Susie", "Jones", "333-33-3333", Date(12, 3, 1985) ,10000, .06};
    BasePlusCommissionEmployee basePlusCommissionEmployee{
        "Boby", "Lewis", "444-44-4444", Date(25, 11, 1975),5000, .04, 300};
    ...
    for (const Employee* employeePtr : employees) {
        double payroll = employeePtr->earnings(); // "nomina de sueldos"

        // Verifica si el mes actual coincide con el mes de cumpleaños
        if (employeePtr->getBirthDate().getMonth() == currentMonth) {
            payroll += 100.0; // Bono de cumpleaños
        }
